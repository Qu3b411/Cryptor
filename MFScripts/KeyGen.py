    ...
    with open ('conf', 'r') as f:
        for line in f.readlines():
            ...
            if(r1 := re.match("PORT_SVR = ([0-9]+)",line)):
                PORT_SVR = r1.group(1);   # its to late if the server port is messed up,
                                          # that should have been checked in conf, anyone
                                          # messing with creating there own conf file should
                                          # know what they are doing
            if(r1 := re.match("CTRL_PORT = ([0-9]+)",line)):
                CTRL_PORT = r1.group(1);  # its to late if the control port is messed up,
                                          # that should have been checked in conf, anyone
                                          # messing with creating there own conf file should
                                          # know what they are doing
